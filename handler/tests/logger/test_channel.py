...
class TestLogChannel(unittest.TestCase):
    ...
    def test_connect_success(self, mock_connection_parameters, mock_plain_credentials, mock_blocking_connection):
        log_channel = LogChannel()
        log_channel.connect()

        mock_plain_credentials.assert_called_once_with(log_channel._username, log_channel._password)
