...
def test_get_user_by_username(db: Session, userfix: dict) -> None:
    ...
    assert seek_user.username == user.username, f"seek_user.username: {seek_user.username}, user.username: {user.username}"
...
def test_super_user_created(db: Session, superuserfix: dict) -> None:
    ...
    assert super_user.email == superuserfix["email"], f"super_user.email: {super_user.email}, superuserfix['email']: {superuserfix['email']}"
    assert super_user.username == superuserfix["username"], f"super.username: {super_user.username}, fix['username']: {superuserfix['username']}"
