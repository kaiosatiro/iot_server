...
class ConnectionManager(metaclass=SingletonConnection):
    ...
    def on_connection_open_error(self, _unused_conn: Connection, err: Exception) -> None:
    ...
    def on_queue_declareok(self, _unused_frame: str) -> None:
        self.logger.info("Queue declared, binding to exchange. Routing key: '%s'", self.ROUTING_KEY)
